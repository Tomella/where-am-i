...
export default class Journal {
   ...
   */
   ...
   async countsByDay() {
      let results = await this.pool.query('SELECT DATE(time_point) AS date_point, COUNT(*) AS total FROM   journal GROUP BY date_point ORDER BY date_point');
