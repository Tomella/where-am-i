   ...
   pointsToJson(points, name = "points") {
      return {
         ...
         features: points.map(point => ({
            type: "Feature",
            properties: {
               name: "Point " + point.time_point.toLocaleString("en-AU") + ", Elevation " + (point.dem > -9999? point.dem: point.elevation).toFixed(2) + "m",
               job_id: point.job_id,
               time_point: point.time_point,
               gps_elevation: point.elevation
            },
            geometry: {
               type: "Point",
               coordinates: [
                  point.longitude,
                  point.latitude,
                  point.dem > -9999? point.dem: point.elevation
               ]
            }
         }))
      };
